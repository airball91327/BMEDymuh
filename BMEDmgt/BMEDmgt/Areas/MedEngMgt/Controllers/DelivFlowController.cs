...
namespace BMEDmgt.Areas.MedEngMgt.Controllers
{
    public class DelivFlowController : Controller
    {
        ...
        public ActionResult GetList(string id = null)
        {
            ...
            {
                p = db.UserProfiles.Find(f.Userid);
        ...
        public ActionResult NextFlow(string id = null)
        {
            ...
            if (ra != null)
            {
                string cid = db.UserProfiles.Find(ra.UserId).CustId;
        ...
        public ActionResult NextFlow(DelivFlow DelivFlow)
        {
            if (ModelState.IsValid)
            {
                ...
                if (DelivFlow.Cls == "結案")
                {
                    ...
                    {
                        u = db.UserProfiles.Find(rr.Userid);
                        sto += u.Email + ",";
                    }
                ...
                DelivFlow.Status = "?";
                u = db.UserProfiles.Find(DelivFlow.Userid);
        ...
        public JsonResult GetNextEmp(string cls = null, string docid = null, string vendor = null)
        {
            ...
            string c = db.UserProfiles.Find(WebSecurity.CurrentUserId).CustId;
            ...
            switch (cls)
            {
                ...
                case "採購人員":
                    if (r != null)
                    {
                        ...
                        li = new ListItem();
                        li.Text = db.UserProfiles.Find(r.PurchaserId).FullName;
                ...
                case "得標廠商":
                    ...
                    {
                        uv = db.UserProfiles.Where(u2 => u2.VendorId == v.VendorId).ToList();
                        foreach (UserProfile u3 in uv)
                        {
                            li = new ListItem();
                            li.Text = u3.FullName;
                            li.Value = u3.UserId.ToString();
                            list.Add(li);
                        }
                    }
                    break;
                case "使用單位":
                    ...
                    if (df != null)
                    {
                        u = db.UserProfiles.Find(df.Userid);
                        if (u != null)
                        {
                            li = new ListItem();
                            li.Text = u.FullName;
