...
namespace BMEDmgt.Areas.MedEngMgt.Controllers
{
    ...
    public class DeliveryController : Controller
    {
        ...
        public ActionResult Index2()
        {
            ...
            {
                listItem2.Clear();
                UserProfile u = db.UserProfiles.Find(WebSecurity.CurrentUserId);
                if (u != null)
                {
                    li = new SelectListItem();
        ...
        public ActionResult Details(string id = null)
        {
            ...
            UserProfile u = db.UserProfiles.Find(Convert.ToInt32(delivery.DelivPson));
            if (u != null)
        ...
        public ActionResult Create(string id = null)
        {
            ...
            {
                p = db.UserProfiles.Find(WebSecurity.GetUserId(s));
                if(p.Status == "Y")
            ...
            {
                p = db.UserProfiles.Find(WebSecurity.GetUserId(s2));
                listItem2.Add(new SelectListItem { Text = p.FullName, Value = p.UserId.ToString() });
            }
            ...
            //
            List<objuser> uv = db.UserProfiles.Join(db.CustOrgans, up => up.CustId, co => co.CustId,
                (up, co) => new objuser
                {
                    uid = up.UserId,
                    uname = up.FullName,
            ...
            foreach (objuser z in uv)
            {
                listItem4.Add(new SelectListItem { Text = z.uname, Value = z.uid.ToString() });
            }
        ...
        public ActionResult Create(Delivery delivery)
        {
            if (ModelState.IsValid)
            {
                ...
                //    }
                //}
                u = db.UserProfiles.Find(Convert.ToInt32(delivery.DelivPson));
                rf.Userid = u.UserId;
                rf.Role = Roles.GetRolesForUser(u.UserName).FirstOrDefault();
                rf.Rtp = null;
                rf.Rdt = null;
                ...
                Vendor v;
                u = db.UserProfiles.Find(Convert.ToInt32(delivery.UserDpt));
                ...
                UserProfile up = db.UserProfiles.Find(delivery.EngId);
                if (up != null)
                {
